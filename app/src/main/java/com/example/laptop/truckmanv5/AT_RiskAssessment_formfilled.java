            ...
            public void onClick(View v) {
                ...
                final String template_message =
                        ">>>>>>> Risk Assessment Report - CHECKLIST<<<<<<<"
                                + '\n'
                                + '\n' + "This is a checklist report, filled on " + startDatestring + " using the KCC App."
                                + '\n'
                ...
                File pdfFile = new File(outputDir, "KCC_Risk_Assessment_Checklist" + startDatestring + ".pdf");
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, ("KCC Risk Assessment Checklist :- " + startDatestring + " Submitted by " + user_namestring));
