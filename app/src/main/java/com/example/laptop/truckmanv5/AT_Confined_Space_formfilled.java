    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailreport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File pdfFile = new File(outputDir, "KCC_Confined_Space_Checklist" + startDatestring + ".pdf");
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, ("KCC Confined Space Checklist :- " + startDatestring + " Submitted by " + user_namestring));
